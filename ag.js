...
function setNewWord() {
    ...
    targetWordElement.textContent = targetWord || 'Start the game!';
}
...
if ('webkitSpeechRecognition' in window || 'SpeechRecognition' in window) {
    ...
    recognition.onresult = function(event) {
        ...
        if (spokenWord === targetWord) {
            ...
            if (count > 5) { // Example condition to end the game
                result.textContent = "Game Over! Your final score is " + count;
